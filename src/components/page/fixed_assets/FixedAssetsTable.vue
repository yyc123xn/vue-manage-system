    ...
    <div class="table">
        <el-col class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 固定资产</el-breadcrumb-item>
            </el-breadcrumb>
        </el-col>
        <el-col class="container">
            <el-col class="handle-box">
                <el-button type="primary" icon="delete" class="handle-del mr10" @click="delAll">批量删除</el-button>
                <el-select v-model="defaultFixedAssetsFilterFields" placeholder="筛选项" class="handle-select mr10">
                    <el-option v-for="fixedAssetsFilterField in fixedAssetsFilterFields"
                               ...
                               :value="fixedAssetsFilterField.columnComment">
                    </el-option>
                </el-select>
...
<script>
    export default {
        ...
        data: function () {
            return {
                defaultFixedAssetsFilterFields: "",
